...
answer1="DNA mutates randomly so the distribution of number of mutations per nucleotide should follow a normal curve"
answer2="DNA mutates randomly so the distribution of number of mutations per nucleotide should be uniform"
answer3="DNA mutates randomly so the distribution of number of mutations per nucleotide should be increasing"
answer4="DNA mutates randomly so the distribution of number of mutations per nucleotide should be decreasing"
quiz "$answer1" "$answer2" "$answer3" "$answer4"
